...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/user-profile-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:10:23 GMT -->
<head>
      ...
      <div class="navbar-vertical-footer-offset">
        ...
        <div class="navbar-vertical-content">
          <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
            ...
            <div id="navbarVerticalMenuPagesMenu">
              ...
              <div class="nav-item">
                <a class="nav-link" href="tournament.php" >
                  ...
                  <span class="nav-link-title">Tournament <span class="badge bg-primary rounded-pill ms-1">5</span></span>
                </a>
              <!-- End Collapse -->

              <!-- Collapse -->
              <div class="nav-item">
                <a class="nav-link" href="tactics.php">
                  <i class="bi-person-badge nav-icon"></i>
                  <span class="nav-link-title">Tactics</span>
                </a>
              </div>
              <!-- End Collapse -->
              ...
              <!-- Collapse -->
              <div class="nav-item">
                <a class="nav-link" href="medical-center.php">
                  <i class="bi-briefcase nav-icon"></i>
                  <span class="nav-link-title">Medical Center</span>
                </a>
              </div>
              <!-- End Collapse -->
              ...
              <!-- Collapse -->
              <div class="nav-item">
                <a class="nav-link" href="scouting.php">
                  <i class="bi-shield-lock nav-icon"></i>
                  <span class="nav-link-title">Scouting</span>
                </a>
              </div>
              <!-- End Collapse -->
            ...
            <div class="nav-item">
              <a class="nav-link" href="wallet.php" data-placement="left">
                <i class="bi-receipt nav-icon"></i>
                <span class="nav-link-title">Wallet</span>
              </a>
            </div>
            <div class="nav-item">
              <a class="nav-link" href="invoice.php" data-placement="left">
                <i class="bi-receipt nav-icon"></i>
        ...
        <div class="col-lg-10">
          ...
          <div class="js-nav-scroller hs-nav-scroller-horizontal mb-5">
            ...
            <ul class="nav nav-tabs align-items-center">
              <li class="nav-item">
                <a class="nav-link active" href="user-profile-projects.html">Tournaments <span class="badge bg-soft-dark text-dark rounded-circle ms-1">3</span></a>
              </li>
              ...
              <li class="nav-item ms-auto">
                <div class="d-flex gap-2">
                  ...
                  <div class="col-sm-auto">
                    <a class="btn btn-primary" href="create-tournament.php">
                      <i class="bi-person-plus-fill me-1"></i> Create Tournament
                    </a>
                  </div>
                  <!-- End Form Check -->
          ...
          <div class="row align-items-center mb-5">
            <div class="col">
              <h3 class="mb-0">8 tournaments</h3>
            </div>
            <!-- End Col -->
...
$conn = mysqli_connect('localhost', 'root', '', 'sportdb');
...
$tournament = mysqli_query($conn, "SELECT * FROM tournament");
...
if ($tournament !== false && mysqli_num_rows($tournament) > 0) {
    while ($userItem = mysqli_fetch_assoc($tournament)) {
        ...
        $logo_1_path = 'uploads/' . $userItem['logo_1'];
        $logo_2_path = 'uploads/' . $userItem['logo_2'];
?>
    ...
    <div class="card card-hover-shadow text-center h-100">
        ...
        <div class="card-body">
            <div class="row align-items-center text-start mb-4">
                <div class="col">
                    <span class="badge bg-soft-success text-primary p-2"><?= $userItem['title']; ?></span>
                </div>
                <!-- End Col -->
                ...
                <div class="col-auto">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="projectsGridDropdown1">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-danger delete-btn" data-id="<?= $userItem['id']; ?>" href="#">Delete</a>
                        </div>
                    </div>
                    <!-- End Dropdown -->
                </div>
            ...
            <div style="gap: 30%;" class="d-flex justify-content-center mb-2 text-center">
                <!-- Logo 1 -->
                <img class="avatar avatar-lg" src="<?php echo $logo_1_path; ?>" alt="Logo 1">
                <h4>VS</h4>
                <!-- Logo 2 -->
                <img class="avatar avatar-lg" src="<?php echo $logo_2_path; ?>" alt="Logo 2">
            </div>

            <div style="gap: 57%;" class="mb-4 d-flex m-3">
                <h2 class="mb-1"><?= $userItem['club_1']; ?></h2>
                <h2 class="mb-1"><?= $userItem['club_2']; ?></h2>
            </div>

            <small class="card-subtitle">Match Result</small>
        ...
        <div class="card-footer">
            ...
            <div class="row col-divider">
                <div class="col">
                    <span class="h4"><?= $userItem['result_1']; ?></span>
                </div>
                <!-- End Col -->

                <div class="col">
                    <span class="h4"><?= $userItem['result_2']; ?></span>
                </div>
                <!-- End Col -->

                <div class="col">
                    <span class="h4"><?= $userItem['result_3']; ?></span>
                </div>
                <!-- End Col -->
            </div>
            <!-- End Stats -->
        ...
        item.addEventListener('click', function(event) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'tournament-delete.php?id=' + userId;
                }
            });
        });
    });
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/user-profile-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:10:24 GMT -->
</html>