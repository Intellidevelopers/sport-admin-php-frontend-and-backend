                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-5">
                                                <a href="create-customer.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle me-2"></i> Add Customers</a>
                                            </div>
                                            <div class="col-sm-7">
                                                ...
                                                <tbody>
                                                    ...
                                                    if(mysqli_num_rows($customers) > 0){
                                                        ...
                                                        <td class="table-user">
                                                            ...
                                                            <a href="javascript:void(0);" class="text-body fw-semibold"><?= $userItem['name']; ?></a>
                                                        </td>
                                                        <td>
                                                            <?= $userItem['phone']; ?>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a href="customer-edit.php?id=<?= $userItem['id']; ?>" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                            <a href="customer-delete.php?id=<?= $userItem['id']; ?>" 
                                                            class="action-icon"
