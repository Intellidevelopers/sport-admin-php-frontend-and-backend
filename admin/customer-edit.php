                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="form-row-preview">
                                                ...
                                                <?php
                                                   ...
                                                   $user = getById('customers', checkParamId('id'));
                                                   if($user['status'] == 200){
                                                ...
                                                <div class="row g-2">
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="name" value="<?= $user['data']['name']; ?>" id="inputname" placeholder="Name" required>
                                                        </div>
                                                        <div class="mb-3 col-md-6">
                                                            <label for="inputPassword4" class="form-label">Username</label>
                                                            <input type="text" class="form-control" name="username" value="<?= $user['data']['username']; ?>" id="inputPassword4" placeholder="Username" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="address" value="<?= $user['data']['address']; ?>" id="inputAddress" placeholder="1234 Main St" required>
                                                    </div>
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="number" name="phone" value="<?= $user['data']['phone']; ?>" class="form-control" id="inputCity" required>
                                                        </div>
                                                        <div class="mb-3 col-md-4">
                                                            <label for="inputState" class="form-label">Role</label>
                                                            <select id="inputState" value="<?= $user['data']['role']; ?>" name="role" class="form-select" required>
                                                                <option value="">Choose</option>
                                                                <option value="customer" <?= $user['data']['role'] == 'customer' ? 'selected':'' ?>>Customer</option>
                                                                <option value="admin" <?= $user['data']['role'] == 'admin' ? 'selected':'' ?>>Admin</option>
                                                                <option value="moderator" <?= $user['data']['role'] == 'moderator' ? 'selected':'' ?>>Moderator</option>
                                                            </select>
                                                        </div>
                                                        <div class="mb-3 col-md-2">
                                                            <label for="inputZip" class="form-label">Zip</label>
                                                            <input type="text" name="zip" value="<?= $user['data']['zip']; ?>" class="form-control" id="inputZip" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-2">
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="customCheck11">Check this box to save all changes</label>
                                                        </div>
                                                    </div>
