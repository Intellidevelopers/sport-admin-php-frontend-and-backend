...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:07:08 GMT -->
<head>
...
?>
      ...
      <div class="row">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              ...
              <div class="row align-items-center gx-2 mb-1">
                <div class="col-6">
                  <h2 class="card-title text-inherit"><?php echo getTotalUsers(); ?></h2>
                </div>
                <!-- End Col -->
        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <a class="card card-hover-shadow h-100" href="#">
            <div class="card-body">
              <h6 class="card-subtitle">Tournament</h6>

              <div class="row align-items-center gx-2 mb-1">
                <div class="col-6">
                  <h2 class="card-title text-inherit"><?php echo getTotalTournament(); ?></h2>
                </div>
                <!-- End Col -->
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:07:56 GMT -->
</html>