...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/account-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:10:27 GMT -->
<head>
  ...
  <main id="content" role="main" class="main">
      ...
      <div class="page-header">
        <div class="row align-items-end">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title">Create Tournament</h1>
          </div>
          <!-- End Col -->
        ...
        <div class="col-lg-9">
          <div class="d-grid gap-3 gap-lg-5">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <!-- Form -->
                <form action="tournament-code.php" method="POST" enctype="multipart/form-data">
                <?= alertMessage(); ?>
                  <!-- Form -->
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                        <input type="text" class="form-control" name="title" id="firstNameLabel" placeholder="World Cup 2022" aria-label="World Cup 2022">
                      </div>
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="club_1" id="club_1Label" placeholder="e.g: Chelsea" aria-label="e.g: Chelsea">
                    </div>
                  </div>
                  <!-- End Form -->
                 ...
                 <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="club_2" id="club_2Label" placeholder="e.g: Manchester" aria-label="e.g: Manchester">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="club_1" class="form-control" name="result_1" id="result_1Label" placeholder="0 6.85" aria-label="0 6.85">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="club_1" class="form-control" name="result_2" id="result_2Label" placeholder="7 6.50" aria-label="7 6.50">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="club_1" class="form-control" name="result_3" id="result_3Label" placeholder="1 0.55" aria-label="1 0.55">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="d-flex justify-content-end">
                    <button type="submit" name="createTournament" class="btn btn-primary">Create</button>
                  </div>
                </form>
                <!-- End Form -->
              </div>
    ...
    <div class="footer">
      <div class="row justify-content-between align-items-center">
        <div class="col">
          <p class="fs-6 mb-0">&copy; Front. <span class="d-none d-sm-inline-block">2022 SportOdd.</span></p>
        </div>
        <!-- End Col -->
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/account-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:10:28 GMT -->
</html>