...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/users.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:08:29 GMT -->
<head>
          ...
          <div class="card h-100">
            <div class="card-body">
              ...
              <div class="row align-items-center gx-2">
                <div class="col">
                  <span class="js-counter display-4 text-dark"><?php echo getTotalUsers(); ?></span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="footer">
      <div class="row justify-content-between align-items-center">
        <div class="col">
          <p class="fs-6 mb-0">&copy; Front. <span class="d-none d-sm-inline-block">2022 Josiah Technology.</span></p>
        </div>
        <!-- End Col -->
            ...
            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              <form>
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-sm-vertical">
                      <input type="text" class="form-control" name="name" id="editFirstNameModalLabel" placeholder="Your first name" aria-label="Your first name" value="Ella">
                    </div>
                  </div>
                </div>
                <!-- End Form -->
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="email" class="form-control" name="editEmailModal" id="editEmailModalLabel" placeholder="Email" aria-label="Email" value="adeagbojosiah1@gmail.com">
                  </div>
                </div>
                <!-- End Form -->
                ...
                <!-- Username -->
                <div class="row mb-4">
                  <label for="editEmailModalLabel" class="col-sm-3 col-form-label form-label">Username</label>

                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="username" id="editEmailModalLabel" placeholder="Email" aria-label="Email" value="prinve12d">
                  </div>
                </div>
                <!-- End Form -->
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" name="country" id="editOrganizationModalLabel" placeholder="Your Country" aria-label="Your Country" value="Nigeria">
                  </div>
                </div>
                <!-- End Form -->
                ...
                <!-- Role -->
                <div class="row mb-4">
                      <label for="formControlLightGenderSelect" class="col-sm-3 col-form-label form-label">Role</label>
                      <div class="col-sm-9">
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-sm-9">
                    <input type="password" class="form-control" name="password" id="editPasswordModalLabel" placeholder="Password" aria-label="Password" value="123456789">
                  </div>
                </div>
                <!-- End Form -->
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/users.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:10:18 GMT -->
</html>