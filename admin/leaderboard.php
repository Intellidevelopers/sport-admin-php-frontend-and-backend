...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/users-leaderboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Apr 2024 20:10:18 GMT -->
<head>
                  ...
                  <tr>
                    ...
                    <td class="table-text-start">
                      <a class="d-flex align-items-center" href="user-profile.html">
                        ...
                        <div class="ms-3">
                          <span class="d-block h5 text-inherit mb-0"><?= $userItem['full_name']; ?></span>
                        </div>
                      </a>
                    </td>
                    ...
                    <td><?= $userItem['last_login']; ?></td>
                    <td><i class="bi-star-fill text-warning me-1"></i> <?= $userItem['id']; ?></td>
                  </tr>
