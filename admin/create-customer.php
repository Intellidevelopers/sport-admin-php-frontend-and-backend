                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="row g-2">
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" name="password" id="inputPass" placeholder="Password">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="inputAddress2" class="form-label">Date created</label>
                                                        <input type="date" class="form-control" name="date_created" id="inputAddress2" placeholder="Apartment, studio, or floor">
                                                    </div>
                                                    ...
                                                    <button type="submit" name="saveCustomer" class="btn btn-primary">Create Customer</button>
                                                </form>                      
                                            </div> <!-- end preview-->
